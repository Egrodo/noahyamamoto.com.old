...
const HeadTag = ({ title, description, path }) => (
  <Helmet defaultTitle="Noah Yamamoto" titleTemplate={`${title} - Noah Yamamoto`}>
    ...
    <meta property="og:image" content="https://noahyamamoto.com/android-chrome-512x512.png?v=2" />

    <meta name="twitter:title" content={title} />
    <meta name="twitter:description" content={description} />
    <meta name="twitter:image" content="https://noahyamamoto.com/android-chrome-512x512.png?v=2" />
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:site" content="@egrodo" />

    <link rel="apple-touch-icon" sizes="180x180" href="https://noahyamamoto.com/apple-touch-icon.png?v=2" />
    <link rel="icon" type="image/png" sizes="32x32" href="https://noahyamamoto.com/favicon-32x32.png?v=2" />
    <link rel="icon" type="image/png" sizes="16x16" href="https://noahyamamoto.com/favicon-16x16.png?v=2" />
